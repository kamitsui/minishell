...
#    Updated: 2023/08/30 10:13:34 by mogawa           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# for mogawa
token:
# cc ./srcs/tokenize_.c ./libft/libft.a -Iincludes -lreadline -o token_tmp -I./libft -g3 -fsanitize=address
	cc ./tokenize.c ./libft/libft.a -I./libft -lreadline -o token -g3 -fsanitize=address
.PHONY:	token